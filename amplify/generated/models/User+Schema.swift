...
extension User {
  ...
  public static let schema = defineSchema { model in
    ...
    model.fields(
      ...
      .field(user.primary_email, is: .required, ofType: .string),
      .field(user.avatar_url, is: .optional, ofType: .string),
      .hasMany(user.courses, is: .optional, ofType: Course.self, associatedWith: Course.keys.user),
